...
[![Tests](https://img.shields.io/badge/tests-516%20passed-brightgreen)](https://github.com/furkan708/mcpify/actions/workflows/ci.yml)
...
- **Proven, not promised** — 516 tests across twenty-eight suites, a hostile-spec corpus, live-CI checks, zero runtime dependencies
...
**516 passing**, plus one live-integration test that loads the real
